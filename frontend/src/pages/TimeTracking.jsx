...
=======
    Personal: { color: 'text-sky-600', bg: 'bg-sky-50', icon: User },
>>>>>>> ad3c40f (Implement task completion time in report and Kanban action menu)
...
=======
                        Time <span className="text-blue-600">Analytics</span>
>>>>>>> ad3c40f (Implement task completion time in report and Kanban action menu)
                    </h1>
...
=======
                                <div className="px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-black text-blue-400 uppercase tracking-widest">Tracking Live</span>
>>>>>>> ad3c40f (Implement task completion time in report and Kanban action menu)
                                </div>
                            )}
                        </div>
...
=======
                                        className="flex-1 md:flex-none flex items-center justify-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-2xl transition-all shadow-xl shadow-blue-600/20 active:scale-95"
>>>>>>> ad3c40f (Implement task completion time in report and Kanban action menu)
                                    >
...
=======
                            <span className="text-[10px] font-black text-blue-500 bg-blue-50 dark:bg-blue-900/20 px-2 py-1 rounded-md">LAST 10 OPS</span>
>>>>>>> ad3c40f (Implement task completion time in report and Kanban action menu)
                        </div>
...
=======
                                            <p className="text-sm font-black text-blue-600">{session.durationMinutes}m</p>
>>>>>>> ad3c40f (Implement task completion time in report and Kanban action menu)
